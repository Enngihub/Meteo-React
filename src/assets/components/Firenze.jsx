...
import backgroundImage from "../img/firenze.jpg";
    ...
    const fetchMeteo = async () => {
      try {
        const response = await fetch(
          `https://api.openweathermap.org/data/2.5/weather?q=firenze&appid=aa6354ec4cfda784e7dcdf2964902721&units=metric&lang=it`
        );
